...
print('')
print('#define EYE_WIDTH  ' + str(IMAGE.size[0]))
print('#define EYE_HEIGHT ' + str(IMAGE.size[1]))
print('')
print('#ifdef SYMMETRICAL_EYELID')
print('')

sys.stdout.write('const uint8_t upper[EYE_HEIGHT * EYE_WIDTH] = {')
...
print('')
sys.stdout.write('const uint8_t lower[EYE_HEIGHT * EYE_WIDTH] = {')
HEX.reset(IMAGE.size[0] * IMAGE.size[1])
